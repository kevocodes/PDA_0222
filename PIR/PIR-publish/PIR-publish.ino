...
// Setup a feed called 'sensorpir' for publishing.
Adafruit_MQTT_Publish sensorpir = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/pir");
...
//Ej: int ledRojo = D1;
//Variables 
int pirpin = D2; //Pin de datos, Digital
...
void loop() {
  ...
  valor = digitalRead(pirpin); //Se lee el estado
  
  Serial.print("Estado: ");
  Serial.println(valor);
  sensorpir.publish(valor);
